...
|                      | 総合テスト結果報告書                 |                        |                               |                                                                                                                                                                   |
|                      |                                      |                        |                               |                                                                                                                                                                   |
|                      |                                      |                        | 機能テスト                    | 仕様書に記載された要件を満たしているか確認                                                                                                                        |
|                      |                                      |                        | ボリュームテスト              | 大量データを扱えるか確認                                                                                                                                          |
|                      |                                      |                        | ストレステスト                | 短時間に大量データを扱えるか確認                                                                                                                                  |
|                      |                                      |                        | 有用度テスト                  | ユーザーのリテラシーに合わせて作られているか確認                                                                                                                  |
|                      |                                      |                        | セキュリティテスト            | 脆弱性を検出するためのペネトレーションテストなど                                                                                                                  |
|                      |                                      |                        | パフォーマンステスト          | 平時の応答速度や処理速度を確認                                                                                                                                    |
|                      |                                      |                        | ストレージテスト              | メモリやストレージの容量の範囲内で利用できるか確認                                                                                                                |
|                      |                                      |                        | 構成テスト                    | ハードウェア構成／ソフトウェア構成ごとの確認                                                                                                                      |
|                      |                                      |                        | 互換性テスト                  | 既存システムと互換性があるか、データ変換手順を確認                                                                                                                |
|                      |                                      |                        | 設置テスト                    | 導入手順の確認                                                                                                                                                    |
|                      |                                      |                        | 信頼性テスト                  | MTBF や MTTR などの信頼性指標が達成されているか確認                                                                                                               |
|                      |                                      |                        | 回復テスト                    | エラーから回復できるか確認                                                                                                                                        |
|                      |                                      |                        | サービス性テスト              | 保守で使う診断プログラムなどのサービス機能を確認                                                                                                                  |
|                      |                                      |                        | 文書テスト                    | マニュアルの記述に基づき確認                                                                                                                                      |
|                      |                                      |                        | 手続きテスト                  | 手作業による操作を確認                                                                                                                                            |
|                      |                                      |                        |                               |                                                                                                                                                                   |
